    ...
    // Spacing Constants Additional
    export const bottomHighlighterWidth = '12.53rem';
    export const categoryTabWidth = '12.6rem';
    export const drawerWidth = '24.0rem';
    export const fieldWidthMinimum = '24.0rem';
    export const candidateDrawer = '56rem';
    
    // VP: Heights and Widths
    export const smHeight = 700;